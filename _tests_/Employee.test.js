...
test('retrives employee name', () => {
    ...
    expect(employee.obtainName()).toEqual(expect.any(String));
});
...
test('retrives employee ID', () => {
    ...
    expect(employee.obtainId()).toEqual(expect.any(Number));
});
...
test('retrives employee email', () => {
    ...
    expect(employee.obtainEmail()).toEqual(expect.stringContaining(employee.email.toString()));
});
...
test('retrives role of employee', () => {
    ...
    expect(employee.obtainRole()).toEqual("Employee");
}); 